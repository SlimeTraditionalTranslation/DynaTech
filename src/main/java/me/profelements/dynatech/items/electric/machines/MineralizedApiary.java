...
public class MineralizedApiary extends AbstractElectricMachine {
	...
	protected void setupMenu(BlockMenuPreset preset) {
        ...
        preset.addItem(20, new CustomItemStack(Material.BEACON, "&f資訊", "&f蜜蜂數量: {}", "&f目前的速度: {}"), ChestMenuUtils.getEmptyClickHandler());
    ...
    private void updateInfoStack(BlockMenu menu, int beeCount) {
        ...
        ItemStack infoStack = new CustomItemStack(Material.BEACON, "&f資訊", "&f蜜蜂數量: " + String.valueOf(beeCount), "&f目前的速度: " + String.valueOf(currSpeed) + "s");
